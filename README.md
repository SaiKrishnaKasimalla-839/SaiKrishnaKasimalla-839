...
<!--
  ✅ SETUP REQUIRED FOR STATS CARDS (one-time, 5 minutes):
  These cards are generated by a GitHub Action and stored directly in YOUR repo.
  GitHub serves them from raw.githubusercontent.com — 100% reliable, never broken.

  HOW TO ACTIVATE:
  1. Go to your repo Settings → Actions → General → set "Workflow permissions" to Read and Write
  2. Create file: .github/workflows/stats.yml  with the content below
  3. The Action runs daily and commits the cards into your repo automatically

  ─── .github/workflows/stats.yml content ───────────────────────────────────────
  ...
  UNTIL YOU SET THAT UP, the stats table and streak card below work perfectly ✅
-->

<!-- ✅ HARDCODED STATS — zero external dependencies, always renders -->
| 📦 Repos | ⭐ Stars | 🔀 PRs | 🐛 Issues | 📅 Contributions | 🏆 Longest Streak |
|:-:|:-:|:-:|:-:|:-:|:-:|
| **10+** | **20+** | **15+** | **5+** | **97** | **10 days** |

> 💡 Update these numbers manually when they grow — or set up the Metrics Action above for auto-updates.

</div>

<div align="center">

<!-- ✅ STREAK — demolab.com is the official maintained host, very stable -->
